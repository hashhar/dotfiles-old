...
alias pkgg="dpkg --get-selections | awk '{print $1}' | grep"
...
# Sound a beep
alias beep="cvlc --play-and-exit /usr/share/sounds/freedesktop/stereo/alarm-clock-elapsed.oga 1>/dev/null 2>&1"
...
alias randommpv='smnohup mpv "$(find . -type f ! -name "*.srt" | shuf | head -n 1)"'
